...
public class ConnectJob extends ThreadJob {
    ...
    public ConnectJob(final long timeout, final ConnectionInformation connectionInformation,
            final long globalSocketTimeout, final int updateRate) {
        super(timeout);
    ...
    protected void perform() throws Exception {
        ...
        /*
         * IJIBindingSelector selector = OPC.createBindingSelector (
         * connectionInformation.getPreferredHosts () );
         */
